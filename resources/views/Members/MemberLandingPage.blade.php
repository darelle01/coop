...
<a href="{{route('Under.Construction')}}"
           ...
           <!-- Mobile User Profile -->
                <div class="border-t pt-4 mt-4">
                    ...
                    <a href="{{ route('Member.Logout') }}" class="block px-4 py-2 rounded-lg hover:bg-red-50 hover:text-red-700 transition-colors text-sm">Logout</a>
                </div>
        </nav>
      </div>
    </header>
    <!-- Hero Section -->
    <section
      class="relative w-full min-h-[70vh] flex items-center justify-center pt-20 pb-12 md:pt-32 md:pb-20 overflow-hidden">
      ...
      <div class="relative z-10 max-w-3xl mx-auto text-center px-4">
        <h1
          class="text-4xl md:text-5xl font-bold text-white mb-4 leading-tight drop-shadow-lg">Your
          Financial Growth,<br><span class="text-green-400">Our
            Priority</span></h1>
        <p class="text-lg md:text-2xl text-green-100 mb-8 font-light">Building
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <form action="{{route('Redirecting.LoanApp')}}" method="GET">
              @csrf
              <input type="text" name="account" value="{{$user_account}}" hidden>
              <button type="submit" class="bg-green-600 text-white px-8 py-3 rounded-full text-lg font-semibold shadow hover:bg-green-700 transition">
                  Apply Loan
              </button>
          </form>

          <a href="learn_about_loaning.html"
            class="border-2 border-white text-white px-8 py-3 rounded-full text-lg font-semibold hover:bg-white hover:text-green-700 transition">Learn
            About Loan</a>
        </div>
      </div>
    </section>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-gray-600 max-w-2xl mx-auto">Comprehensive
            financial solutions designed to meet your needs and help you
            achieve
            your goals.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <!-- Loans Card -->
          <div
            class="bg-white rounded-2xl p-8 shadow-lg hover-lift hover:shadow-xl">
            <div
      ...
      <section class="py-20 bg-white">
        ...
        <section id="news" class="py-20 bg-gray-50">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <article
                class="bg-white rounded-2xl shadow-lg overflow-hidden hover-lift hover:shadow-xl">
                <img src="{{asset('images/event1.jpg')}}" alt="Event 1"
                  class="rounded-t-2xl w-full h-56 object-cover">
                <div class="p-6">
                  <span
                    class="text-sm text-green-600 font-semibold mb-6">March
                    22,
                    2024</span>
                  <h3
                    class="text-xl font-semibold text-gray-900 mt-2 mb-3">22nd
                    Annual
                    General Assembly of Greater Bulacan Livelihood Development
                    Cooperative</h3>
                  <p class="text-gray-600 mb-4">Held last March 22,
                    2024 @ Cafe De Apati, Makinabang, Baliuag, Bulacan. Join
                    us
                    for
                    an engaging discussion on cooperative development and
                    future
                    initiatives.</p>
                  <a href="#"
              ...
              <article
                ...
                <img src="{{asset('images/event2.jpg')}}" alt="Event 2"
                  class="rounded-t-2xl w-full h-56 object-cover">
                <div class="p-6">
                  <span class="text-sm text-green-600 font-semibold">August
                    15,
                    2025</span>
                  <h3
                  ...
                  <p class="text-gray-600 mb-4">Empowering
                    ...
                    Month
                    2023. Join us for a day of celebration and awareness of
                    the
            ...
            <div class="max-w-7xl mx-auto px-4">
                ...
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                    <div
                      ...
                      <div class="relative flex-shrink-0">
                        <img src="path/images/member-testimonial.jpg"
                      ...
                      <div class="flex-1 max-w-2xl">
                        <div class="testimonial-card">
                          ...
                          <p
                            ...
                            resistensya. Pinagpapasalamat ko po sa GBLDC
                            anuman
                  ...
                  <div class="swiper-slide">
                    <div
                      class="flex flex-col lg:flex-row items-center gap-12 max-w-6xl mx-auto">
                      <div class="relative flex-shrink-0">
                        <img src="{{asset('images/member-testimonial-2.jpg')}}"
                          alt="Maria Santos"
                          class="member-image">
                      </div>
                      <div class="flex-1 max-w-2xl">
                        <div class="testimonial-card">
                          ...
                          <p
                            class="text-lg text-gray-800 leading-relaxed mb-6 relative z-10">
                            Napakaganda ng serbisyo ng GBLDC. Nakatulong
                            talaga
                  ...
                  <div class="swiper-slide">
                    <div
                      class="flex flex-col lg:flex-row items-center gap-12 max-w-6xl mx-auto">
                      <div class="relative flex-shrink-0">
                        <img src="path/images/member-testimonial-3.jpg"
                          alt="Roberto Cruz"
                          class="member-image">
                      </div>
                      <div class="flex-1 max-w-2xl">
                        <div class="testimonial-card">
                          ...
                          <p
                            class="text-lg text-gray-800 leading-relaxed mb-6 relative z-10">
                            Matagal na akong miyembro ng GBLDC at nakita ko
                            kung
              ...
              <div class="flex justify-center items-center mt-12 gap-8">
                <div class="text-center">
                  ...
                  <p class="text-sm text-gray-600">Trusted by 1000+
                    members</p>
                </div>
              </div>
            </div>
          ...
          <div id="chatbot-widget"
            ...
            <div
              ...
              <img src="path/images/logocoop-removebg-preview 2.png" alt="GBLDC"
          ...
          <div class="max-w-7xl mx-auto px-4">
            <div
              ...
              <div class="flex flex-col items-center md:items-start">
                <h4
                  class="font-semibold mb-3 uppercase tracking-wide text-lg">Services</h4>
<ul class="space-y-2">
                  <li><a href="{{route('Under.Construction')}}"
            ...
            <div
              ...
              <div class="flex space-x-6 mt-4 md:mt-0 md:text-center">
                <a href="#"
                  ...
                  Policy</a>
                <a href="#"
                  class="text-white  text-sm transition-colors hover:underline">Terms
                  of
                  Service</a>
                <a href="#"
                  class="text-white  text-sm transition-colors hover:underline">Cookie
                  Policy</a>
              </div>
            </div>
