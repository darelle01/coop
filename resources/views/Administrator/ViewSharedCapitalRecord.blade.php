              ...
              <form action="{{route ('Payment.Submit')}}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                @csrf
                  ...
                  <div class="pt-4 flex justify-center">
                      ...
                      <a href="{{route ('View.SCP.History', $Record->member_id)}}" class="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 px-6 rounded-lg focus:ring-4 focus:ring-blue-300 focus:outline-none transition-all duration-200">Back</a>
                  </div>
              </form>
          </div>
      </div>
