...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Shared Capital | GBLDC Admin</title>
  ...
  <body class="bg-gray-50 text-gray-800 font-sans antialiased min-h-screen">
    ...
    <header class="bg-white shadow-md fixed left-0 top-0 z-50 w-full">
      <div
        ...
        <div class="flex items-center space-x-4">
          ...
          <h1 class="text-lg md:text-xl font-semibold text-teal-900">GBLDC Shared Capital Payment History</h1>
        </div>
        <div class="relative">
    ...
    <!-- Title -->
    <div class="mb-8">
      <h2 class="text-2xl font-bold text-green-800">Shared Capital Payment History</h2>
